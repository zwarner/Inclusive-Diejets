...
// Tue Oct 27 14:26:59 2020 by ROOT version 6.18/04
// from TTree Delphes/Analysis tree
// found on file: run3.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4092;
   static constexpr Int_t kMaxTrack = 146;
   static constexpr Int_t kMaxTower = 265;
   static constexpr Int_t kMaxEFlowTrack = 146;
   static constexpr Int_t kMaxEFlowPhoton = 80;
   static constexpr Int_t kMaxEFlowNeutralHadron = 167;
   static constexpr Int_t kMaxGenJet = 9;
   static constexpr Int_t kMaxGenMissingET = 1;
   static constexpr Int_t kMaxJet = 9;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run3.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run3.root");
      }
